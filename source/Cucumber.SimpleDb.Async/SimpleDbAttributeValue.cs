...
namespace Cucumber.SimpleDb.Async
{
    ...
    public class SimpleDbAttributeValue
    {
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="SimpleDbAttributeValue"/>.
        /// If the attribute is multi-value, will contain the first value.
        /// If the attribute has no values, will return an empty string.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="SimpleDbAttributeValue"/>.</returns>
        ...
        /// <summary>
        /// Serves as a hash function for a <see cref="SimpleDbAttributeValue"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="System.Object"/> is equal to the current <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if any one value is matched in both attributes,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="obj">The <see cref="System.Object"/> to compare with the current <see cref="SimpleDbAttributeValue"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="System.Object"/> is equal to the current
        /// <see cref="SimpleDbAttributeValue"/>; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is greater than the second  <see cref="SimpleDbAttributeValue"/>.
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is less than the second  <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if the condition is true for any one pairing,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="left">Left.</param>
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is greater than or equal to the second  <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if the condition is true for any one pairing,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="left">Left.</param>
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is less than or equal to the second <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if the condition is true for any one pairing,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="left">Left.</param>
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is equal to the second <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if the condition is true for any one pairing,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="left">Left.</param>
        ...
        /// <summary>
        /// Determines whether the first <see cref="SimpleDbAttributeValue"/> is not equal to the second <see cref="SimpleDbAttributeValue"/>.
        /// For multi-value attributes, returns true if the condition is true for any one pairing,
        /// unless preceded by Every()
        /// </summary>
        /// <param name="left">Left.</param>
